...
- **Built-in assistant chat** — `⌃Space` opens a dedicated chat with selectable CLI provider support (Claude, GitHub Copilot, or OpenAI Codex), optional TermHub MCP access, and provider-specific assistant settings.
